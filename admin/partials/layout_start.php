...
<body>
    <nav class="admin-sidebar">
        ...
        <ul class="nav flex-column py-2">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (strpos($_SERVER['SCRIPT_NAME'], 'khoa-hoc') !== false) echo 'active'; ?>" href="<?php echo SITE_URL; ?>/admin/khoa-hoc/index.php">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (strpos($_SERVER['SCRIPT_NAME'], 'thong-ke') !== false) echo 'active'; ?>" href="<?php echo SITE_URL; ?>/admin/thong-ke/index.php">
